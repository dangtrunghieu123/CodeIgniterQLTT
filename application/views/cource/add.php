                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
                                        ...
                                        <div class="form-line">
											<input type="text" class="form-control" placeholder="Nhập tên khóa học" name="nameCourse" required>
                                        </div>
                                    </div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										<label>Gía</label>
                                        <div class="form-line">
											<input type="number" class="form-control" placeholder="giá khóa học" name="price" required>
                                        </div>
                                    </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">

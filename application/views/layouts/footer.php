    ...
    <script src="<?=base_url()?>public/assets/themes/admin/plugins/jquery-datatable/extensions/export/buttons.flash.min.js"></script>
    <script src="<?=base_url()?>public/assets/themes/admin/plugins/jquery-datatable/extensions/export/jszip.min.js"></script>
    <script src="<?=base_url()?>public/assets/themes/admin/plugins/jquery-datatable/extensions/export/pdfmake.min.js"></script>
    <script src="<?=base_url()?>public/assets/themes/admin/plugins/jquery-datatable/extensions/export/vfs_fonts.js"></script>

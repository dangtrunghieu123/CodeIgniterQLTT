			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="price" value="<?php echo ($this->input->post('price') ? $this->input->post('price') : $course['price']); ?>" class="form-control" id="price" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="desription" class="form-control" id="desription"><?php echo ($this->input->post('desription') ? $this->input->post('desription') : $course['desription']); ?></textarea>

				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="userClassID" value="<?php echo ($this->input->post('userClassID') ? $this->input->post('userClassID') : $detail_uc['userClassID']); ?>" class="form-control" id="userClassID" />
